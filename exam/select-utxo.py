...
# Select optimal outputs for a send from unspent outputs list. # Returns output list and remaining change to be sent to
# a change address.
def select_outputs_greedy(unspent, min_value):
	...
	for utxo in lessers:
		...
		if accum >= min_value:
			...
			return result, "Change: %d Satoshis" % change # No results found.
